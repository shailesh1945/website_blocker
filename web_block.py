...
l2 = Label(window, text='Enter Website:', bg='#00E6F6', font=("Copperplate Gothic Bold", 14))
...
b1 = Button(window, text="ADD", bg='#00E6F6', font=("Copperplate Gothic Light", 12), command=grab)
b1.grid(row=1, column=2)
b1.place(x=750, y=50)

l3 = Label(window, text="List of Websites", bg='#00E6F6', font=("Copperplate Gothic Bold", 14))
l3.grid(row=2, column=0)
l3.place(x=100, y=150)

b2 = Button(window, text="SHOW ALL", command=show_all, bg='#00E6F6', font=("Copperplate Gothic Light", 12))
b2.grid(row=2, column=2)
b2.place(x=750, y=125)

b3 = Button(window, text="REMOVE", command=DeleteSelection, bg='#00E6F6', font=("Copperplate Gothic Light", 12))
b3.grid(row=3, column=2)
b3.place(x=750, y=175)

l4 = Label(window, text="Custom Start time:", bg='#00E6F6', font=("Copperplate Gothic Bold", 14))
...
l5 = Label(window, text="Custom End time:", bg='#00E6F6', font=("Copperplate Gothic Bold", 14))
...
b4 = Button(window, text="Start", command=start, bg='#00E6F6', font=("Copperplate Gothic Bold", 12))
b4.grid(row=12, column=0, columnspan=2, rowspan=2)
b4.place(x=450, y=550)

b5 = Button(window, text="End", command=end, bg='#00E6F6', font=("Copperplate Gothic Bold", 12))
